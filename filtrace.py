...
try:
    ...
    dataset = gdal.Open(r"C:\Users\admin\Documents\vsb\programovani\cvicna_data\teren")
except RuntimeError:
...
dsOut = driver.Create(r"C:\Users\admin\Documents\vsb\programovani\teren_hrany.tiff", sloupce, radky, 1, gdal.GDT_Float32)
